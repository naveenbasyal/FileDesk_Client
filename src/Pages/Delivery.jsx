                  ...
                  <motion.div key={index} whileHover={{ scale: 1.05 }}>
                    ...
                    >
                      <div className="col-lg-3 center">
                        <i className={`fa-solid fa-eye my-2 fs-3 ${showThumbail ? 'dim': ""}`} onClick={handleThumbail}></i>
                        {/* ------Thumbnail---------- */}
                        {showThumbail ? <motion.img
                      ...
                      <div className="col-lg-7 py-3">
                        ...
                        <div className="d-flex my-3 row bind">
                          <div className="col-lg-3">
                            <span className="fw-bold dim mx-4">Bindings:</span>
                          </div>
                          <div className="col-lg-9 d-flex justify-content-around">
                            ...
                            <div className="col-lg-5">
                              <div className="form-check margin-0 mx-3">
                                <input
                                  onClick={() => setPlasticCover(!plasticCover)}
                                  className="form-check-input"
                                  type="checkbox"
                        ...
                        <div className="d-flex my-3 setup row">
                          <div className="col-lg-3">
                            <span className="fw-bold dim mx-4">Sides:</span>
                          </div>
                        ...
                        <div className="d-flex my-3 color  row">
                          <div className="col-lg-3">
                            <span className="fw-bold dim mx-4">Colors:</span>
                          </div>
                      ...
                      <div className="col-lg-2 py-4 deleteIcon">
                        ...
                        {/* ------------- Single Pdf Price------- */}
                        <div className="position-absolute eye  bottom-0 filePrice pb-5 mb-2">
