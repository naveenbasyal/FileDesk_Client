...
const DocToPdf = () => {
  ...
  const convert = async () => {
    ...
    console.log(data);
    setPdf(`${process.env.REACT_APP_SERVER_URL}/${data.path}`);
  };
  console.log(pdf);
  ...
  return (
    <div className="container center my-5 pop">
      <div className="col-lg-8 col-md-10 col-sm-12">
        <h1 className="stroke ls-2 mx-4 center">Convert Word to PDF</h1>
        {pdf ? (
          <div className="d-flex my-5 justify-content-around center">
            <h3 className="dim mx-4 center">Download PDF</h3>
            <motion.a
              href={pdf}
              download={pdf}
              className="u-f-b"
